...
def seg_kmeans_color(img_path):
    ...
    # plt.subplot(132), plt.imshow(img_output), plt.title('kmeans')
    # plt.subplot(133), plt.imshow(img_output), plt.title('kmeans')
    # plt.show()

if __name__ == '__main__':
    img = seg_kmeans_color(r"E:\暑期线上实习\BSDS300\images\train\2092.jpg")
    print(img)
